...
<html lang="ru">
  <head>
    <title>Задайте Ваш вопрос или тему для обсуждения - Кухни под заказ в Смоленске</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="content">
	  <div class="container">
	    <div class="content__subheader">Задайте Ваш вопрос или тему для обсуждения</div>
		<form class="form__question">
		  <input class="bordered-bottom" name="Имя" value="" placeholder="Введите Ваше имя">
		  <input class="bordered-bottom" name="Контакты" value="" placeholder="Введите телефон или e-mail">
		  <input required class="bordered-bottom" name="Сообщение" value="" placeholder="Вопрос или сообщение">
		  <input class="pulse-button  form__question-send" type="submit" value="Отправить">
		</form>
